...
mod tests {
    ...
    #[test]
    fn test_u32_enc() {
        let result = (32u32).encode_fixed_vec();
        assert_eq!(result, vec![32, 0, 0, 0]);
    }
    #[test]
    fn test_u16_enc() {
        let result = (256u16).encode_fixed_vec();
    ...
    #[test]
    fn test_u8_enc() {
        let result = (255u8).encode_fixed_vec();
        assert_eq!(result, vec![255]);
    }
    #[test]
    fn test_i8_enc() {
        let result = (-1i8).encode_fixed_vec();
        assert_eq!(result, vec![255]);
    }
    #[test]
    fn test_i16_enc() {
        let result = (-32768i16).encode_fixed_vec();
        assert_eq!(result, vec![0, 128]);
    }
    #[test]
    fn test_i32_enc() {
        let result = (-32767i32).encode_fixed_vec();
    ...
    */
    ...
    fn test_invalid_encode_size() {
        let mut buf = [0u8; 4];
        (11u64).encode_fixed(&mut buf).unwrap();
    }
